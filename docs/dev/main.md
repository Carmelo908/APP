...
- la librería Jetpack Compose para crear la interfaz gráfica
- la librería Retrofit2 para el consumo de la API
...
- [**data**](data.md): contiene código relacionado con el manejo de datos de usuario y la interacción de la aplicación con el servidor. Está dividido en 3 subpaquetes:
...
- [**navigation**](navigation.md): contiene la funcionalidad de la navegación entre pantallas, la declaración de todas las rutas necesarias para esta navegación y se asocian todas las rutas a una pantalla dentro del paquete *screens*.

- [**screens**](screens.md): contiene funciones *@composable* que crean las distintas pantallas dentro del programa. cada pantalla contiene en su archivo la funcionalidad necesaria para las acciones que el usuario puede realizar en ellas.
